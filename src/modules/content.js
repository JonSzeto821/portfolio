const initialState = {
  about: {
    ...
    bio: {
      p1:
        'Aspiring Front End Engineer, with Full Stack capabilities. I have prior experience on a Front End development team, as a Systems Analyst, at a Financial Institution. Following that, I transitioned to a customer facing role, as an Integration Manager, at an Education Technology company.',
      p2:
